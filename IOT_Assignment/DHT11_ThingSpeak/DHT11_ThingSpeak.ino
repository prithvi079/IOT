...
char ssid[] = "Madhvi";  //SSID
char pass[] = "rohitmadhvi1617@";  //Password
//-----------------------------------//
...
//-------------ThingSpeak Details-----------------//
unsigned long myChannelField = 1644747; //Channel ID
const int ChannelField1 = 1; //for Humidity
const int ChannelField2 = 2; //for Temperature
const char * myWriteAPIKey = "42SICECWTRZYV734"; //Your Write API Key
//-----------------------------------------------//
